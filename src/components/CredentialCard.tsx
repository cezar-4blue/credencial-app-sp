...
export function CredentialCard({ nome, empresa, fotoUrl, onBackToForm }: Props) {
  ...
  const centralUrl = "https://cont.4blue.com.br/central-participantes-sp/";
  ...
  return (
    <div className="w-full max-w-md flex flex-col items-center gap-6 fade-in-up my-4">
      <div
        ref={cardRef}
        className="w-full flex flex-col items-center justify-between p-8 relative shadow-2xl overflow-hidden metallic-shine border transition-all duration-500"
        style={{
          borderRadius: "2.25rem",
          background: "linear-gradient(155deg, #11141c 0%, #0a0c10 50%, #171308 100%)",
          borderColor: "rgba(212, 175, 55, 0.65)",
          boxShadow: "0 25px 60px rgba(212, 175, 55, 0.25), inset 0 1px 2px rgba(255, 215, 0, 0.3)"
        }}
      >
        ...
        <div className="w-full flex justify-between items-center mt-3 z-10">
          ...
          <span className="text-[10px] uppercase tracking-[0.35em] font-mono text-muted-foreground/90 font-semibold">
            PASSE OFICIAL 2026
          </span>
        ...
        <div className="w-full bg-gradient-to-r from-[#B8860B] via-[#FFD700] to-[#D4AF37] text-black py-2 px-4 rounded-xl my-3 flex items-center justify-between shadow-xl z-10 font-bold uppercase tracking-wider text-xs">
          <span className="flex items-center gap-1.5">
            <Sparkles className="w-4 h-4 fill-black/20" /> IMERSÃO PRESENCIAL • 2 DIAS
          </span>
          <span className="text-[11px] tracking-widest font-mono bg-black/20 px-2.5 py-0.5 rounded-md text-black font-extrabold">
            28 & 29 AGO
          </span>
        </div>
        ...
        <div className="w-full flex flex-col items-center z-10 my-3">
          ...
          <span className="text-[10px] tracking-[0.35em] uppercase text-muted-foreground/80 font-bold mb-1">
            PARTICIPANTE CONFIRMADO
          </span>

          <h2 className="font-heading text-2xl font-black uppercase tracking-tight text-center z-10 text-[#FFD700] drop-shadow-[0_2px_10px_rgba(255,215,0,0.4)] px-2 leading-tight">
            {nome}
          </h2>
        ...
        <div className="w-full grid grid-cols-2 gap-3 text-muted-foreground text-xs font-medium z-10 px-1">
          <div className="flex items-center gap-2 justify-center bg-black/50 p-2.5 rounded-xl border border-white/10 shadow-inner">
            ...
            <div className="flex flex-col text-left leading-tight">
              ...
              <strong className="text-white text-xs">São Paulo / SP</strong>
            </div>
          </div>
          <div className="flex items-center gap-2 justify-center bg-black/50 p-2.5 rounded-xl border border-white/10 shadow-inner">
        ...
        <div className="mt-4 text-[9px] font-mono text-muted-foreground/70 flex items-center gap-1.5 z-10">
          ...
          <span className="tracking-wider">4BLUE WORKSHOP • 28 E 29 DE AGOSTO</span>
        </div>
      </div>
      ...
      <div className="flex flex-col w-full gap-3">
        ...
        <button onClick={saveAsImage} className="neon-button h-14 w-full flex items-center justify-center gap-2 text-base shadow-xl cursor-pointer">
          ...
          Baixar Credencial HD (Imagem)
        </button>
        <a
          href="https://cont.4blue.com.br/central-participantes-sp/"
          target="_blank"
          rel="noopener noreferrer"
          className="h-14 w-full rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 hover:from-blue-500 hover:to-indigo-500 text-white font-heading font-bold uppercase tracking-wider text-sm flex items-center justify-center gap-2.5 shadow-lg border border-blue-400/30 transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] cursor-pointer"
        >
