...
export function CredentialForm({ onSuccess, utmParams }: Props) {
  ...
  const onSubmit = async (data: CredentialFormData) => {
    ...
    try {
      const WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbx5Db2bOfkP6y50YfOERtTI2rsp1_7TaGWgbRo05LIhlIlO3zlQ7OZ-UyjqkN5PS64/exec";
      ...
      <div className="flex flex-col items-center justify-center p-4 rounded-xl border border-primary/30 bg-secondary/40 backdrop-blur-sm gap-3">
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Adicione sua foto para personalizar sua Credencial Digital dos 2 dias de imersão
          </p>
        </div>
